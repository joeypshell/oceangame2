...
| `assets/terrain/background_rocks_02.png` | 512x256 | Distant rock silhouettes | draft | Controlled Visual Revision 04 candidate; non-collision background-depth variant generated by `tools/generate_background_depth_sprite.py`. |
