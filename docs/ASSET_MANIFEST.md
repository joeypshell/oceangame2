...
Compact feedback/audio cues are generated deterministically by `tools/generate_feedback_cue_assets.py`. The original #482 placeholders were refined by #1021 into distinct collection, banking, oxygen, warning, and impact families while preserving the established runtime cue ids.

| Asset | Size | Purpose | Status | Notes |
|---|---:|---|---|---|
| `assets/audio/cues/salvage_pickup.wav` | 22.05 kHz mono | Salvage enters held cargo | candidate | Bright rising find. |
| `assets/audio/cues/material_pickup.wav` | 22.05 kHz mono | Recipe material enters held cargo | candidate | Dry click and descending clink. |
| `assets/audio/cues/salvage_bank.wav` | 22.05 kHz mono | Held salvage banks at extraction | candidate | Low confirmation followed by resolved rise. |
| `assets/audio/cues/oxygen_low.wav` | 22.05 kHz mono | Existing oxygen low threshold warning | candidate | Airy low double pulse. |
| `assets/audio/cues/oxygen_critical.wav` | 22.05 kHz mono | Existing oxygen critical threshold warning | candidate | Faster airy three-pulse escalation. |
| `assets/audio/cues/oxygen_failure.wav` | 22.05 kHz mono | Existing oxygen failure/reset result | candidate | Long descending vent. |
| `assets/audio/cues/hazard_warning.wav` | 22.05 kHz mono | Existing hazard warning state begins | candidate | High metallic alternating alarm. |
| `assets/audio/cues/hazard_contact.wav` | 22.05 kHz mono | Existing hazard contact penalty/reset | candidate | Noise transient and low impact. |
| `assets/audio/cues/upgrade_purchase.wav` | 22.05 kHz mono | Existing session upgrade purchase succeeds | candidate | Bright rising arpeggio; optional runtime wiring. |
