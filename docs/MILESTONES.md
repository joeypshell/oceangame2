...
Simple Diver Game 01-09 and OceanGame Expansions 01-06 are complete with GO decisions. Expansion 06 proved one authored territory, one non-circular first weapon, separate health, an evade-or-fight choice, deterministic review, and exact-SHA Web deployment without broadening combat into the core loop.
...
- Committed: no implementation batch is active after the Expansion 06 closeout.
- Directional: Expansion 07 is the next planning candidate; Expansions 08-09 retain goals and exit criteria only.
...
1. [Expansion 07: Biological Resources And Weapon Progression](https://github.com/joeypshell/oceangame2/milestone/33) - passive/hostile creature materials and one equipment progression step.
2. [Expansion 08: Daily Conditions And Enemy Ecology](https://github.com/joeypshell/oceangame2/milestone/34) - readable seeded opportunities inside stable geography and a broader small ecology.
3. [Expansion 09: Regional World Growth](https://github.com/joeypshell/oceangame2/milestone/35) - memorable authored regions through the JSON pipeline.
...
No expansion implementation batch is active. The next drift cycle should lock the Expansion 07 plan, then create about ten independently actionable issues for one bounded biological-resource-to-equipment proof. #52/#53 remain deferred optional slice-03 polish.

## Roadmap Rules

- Plan and batch only Expansion 07 next; do not pre-batch Expansions 08-09.
