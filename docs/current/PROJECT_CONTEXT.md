...
- Open active batch: #110-#119 cover Controlled Gameplay Pass 02 planning, route-choice validation, oxygen pressure tuning, salvage value tiers, one source-authored risk/reward placement in `production_slice_01`, baseline review, and public Web preview verification.
...
1. Resolve #110 to plan Controlled Gameplay Pass 02 around route choice, oxygen pressure, and salvage payoff.
2. Resolve #111-#119 as a small batch: deterministic route-choice probe, oxygen pressure tuning and decision, salvage value tiers, a distinct high-value salvage marker, one source-authored risk/reward placement in `production_slice_01`, route validation, baseline review, and public Web preview verification.
