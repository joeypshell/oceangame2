...
- The first controlled visual-revision target is a named sprite asset pass for salvage and hazard props. It should preserve map data, collision, behavior, debug markers, and accepted baselines until review.
...
1. Do #70 to implement the controlled sprite prop pass for salvage and hazards.
