...
1. Do #76, then #77, #78, and #79 for the Controlled Visual Revision 02 player/diver sprite pass.
2. Do #80 and #81 to harden asset-path and public-preview verification.
3. Do #83 to capture the controlled visual-revision workflow as a checklist.
4. Do #84 only after the player pass is reviewed or deliberately deferred.
5. Keep #52/#53 as optional post-baseline slice-03 improvement issues if the accepted slice-03 reference needs intentional camera or source cleanup.
