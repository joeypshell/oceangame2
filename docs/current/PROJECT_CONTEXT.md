...
- Active plan/ordered issues: [LE07](LIVING_EXPEDITION_07_PLAN.md#ordered-active-issues), milestone #51 / #1389-#1397; [source/state contract](LIVING_EXPEDITION_07_SOURCE_STATE_CONTRACT.md) and [placement evidence](LIVING_EXPEDITION_07_SOURCE_VERIFICATION.md) are established; refuge excavation and boat/night growth are implemented; [memory/night evidence](LIVING_EXPEDITION_07_MEMORY_NIGHT_VERIFICATION.md) records the boundary, with Ground Pin next
...
- Next issue: #1393 implements physical Ground Pin. #1391-#1392 complete the refuge event, identity-bound boat save, and deliberate night Root Claws/deferral; #1394-#1397 remain presentation/review work. Habitat legacy/release remains directional
...
- Active: [milestone #51](https://github.com/joeypshell/oceangame2/milestone/51), LE07 Marl's Root Claws, #1389-#1397. Schema #1389, source #1390, field event #1391, and boat/night #1392 are implemented; #1393-#1397 remain runtime/review work, ending at the owner gate. Do not create another batch.
...
Living Expeditions 01-03 and 05-06 are complete with owner GO. Living Expedition 04 is technically complete and closed on owner HOLD: Mica's eel prediction is retired, Guardian-Pulse Kite remains the only active companion eel response, and BOND uses a whole-simulation tactical pause. Milestone #50 and #1366-#1375 close the Signal Reef nursery return at runtime `16300a9`. #1387 selects `LIVING_EXPEDITION_07_PLAN.md`: a meaningful refuge dig becomes Marl's boat-secured memory, deliberate night Root Claws, and next-sortie Ground Pin. The field event and boat/night growth are implemented in #1391-#1392; the physical action payoff is not yet complete. Milestone #51 already contains #1389-#1397. Continue with #1393 Ground Pin, then presentation, integrated checks, visual/Web, and owner verdict. See the plan's ordered links; habitat legacy/release and #52/#53 remain deferred.
