...
- Open active batch: #109-#119 cover the post-Gameplay-Pass-01 roadmap refresh, Controlled Gameplay Pass 02 planning, route-choice validation, oxygen pressure tuning, salvage value tiers, one source-authored risk/reward placement in `production_slice_01`, baseline review, and public Web preview verification.
...
1. Resolve #109 to refresh the roadmap after Controlled Gameplay Pass 01.
2. Resolve #110 to plan Controlled Gameplay Pass 02 around route choice, oxygen pressure, and salvage payoff.
3. Resolve #111-#119 as a small batch: deterministic route-choice probe, oxygen pressure tuning and decision, salvage value tiers, a distinct high-value salvage marker, one source-authored risk/reward placement in `production_slice_01`, route validation, baseline review, and public Web preview verification.
4. Keep #52/#53 as optional post-baseline slice-03 improvement issues unless the selected goal shifts back to slice-03 presentation.
