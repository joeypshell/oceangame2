...
1. Do #72 to verify the public web preview after the prop sprite pass.
2. Do #73 to plan Controlled Visual Revision 02.
3. Do #74 to refresh the actionable backlog from that plan.
4. Do #75 before relying on `production_slice_01` for clean controlled visual-revision diffs.
