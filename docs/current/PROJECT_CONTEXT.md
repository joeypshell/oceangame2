...
- `assets/terrain_tiles/cave_tileset_v2.png` is the active draft runtime terrain atlas under #95; `cave_tileset_v1.png` remains committed for comparison and rollback until #96 accepts or defers the v2 baseline.
...
1. Keep #52/#53 as optional post-baseline slice-03 improvement issues if the accepted slice-03 reference needs intentional camera or source cleanup.
2. Plan the next small controlled pass before implementing more visual changes.
