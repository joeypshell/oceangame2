...
- Open active batch: #118-#119 cover route-payoff baseline review and public Web preview verification after the valuable salvage route change.
...
1. Resolve #118 to accept the route-payoff visual baseline.
2. Resolve #119 to verify the public Web preview after the route-payoff pass.
