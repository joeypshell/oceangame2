...
1. [#36](https://github.com/joeypshell/oceangame2/issues/36) locks an accepted production-slice visual baseline before larger visual changes.
2. [#37](https://github.com/joeypshell/oceangame2/issues/37) and [#38](https://github.com/joeypshell/oceangame2/issues/38) improve debug marker review and capture framing.
3. [#39](https://github.com/joeypshell/oceangame2/issues/39) adds one scoped pressure mechanic only after visual/source validation is stable.
4. [#40](https://github.com/joeypshell/oceangame2/issues/40) selects a second production slice once the first slice workflow is accepted.
