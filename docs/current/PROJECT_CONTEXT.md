...
1. Do #79 to verify the public web preview after the accepted player sprite pass.
...
4. Do #84 only after the player pass public-preview verification is complete or deliberately deferred.
