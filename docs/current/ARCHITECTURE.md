...
- `scripts/main/main.gd`
  ...
  - Delegates visual capture flags to `scripts/main/capture_controller.gd` and focused capture helpers, including camera tests, route outcome, timed/pry/cutter salvage, controlled-pass states, progression/connectors, anomaly survey, expedition day, Expansion 03 material/project, Expansion 04 current-pocket, Expansion 05 practical research, Expansion 06 combat, and Expansion 07 biological progression review states.
  - Delegates smoke checks to `scripts/main/smoke/`, including safe/deep route comparison, timed/pry/cutter salvage, Expansion 03-07 journeys, focused combat/biological/current/profile state, hazard and oxygen pressure, cargo/scoring, route/result/facing checks, and production-slice routes.
