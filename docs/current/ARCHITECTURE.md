...
The long-range product roadmap is `docs/planning/OCEANGAME_PHASE_2_ROADMAP.md`. Expansion 13 remains at owner HOLD after exact runtime `89371d6`. #1000-#1006 establish the active-tool correction, compact controls, named material presentation, and the sealed-wreck navigation reward from cutter completion through canonical-boat commitment; integrated evidence remains in #1007-#1009. #969 remains the owner replay gate and no next expansion is selected.
...
- `--smoke-expansion-13-scanner-cutter-correction` protects the fresh and migrated scanner-to-cutter chain, forward-cone selection and cancellation, physical artifact presentation, no-recipe-before-commit rule, exact materials/night build, separate sealed-wreck salvage value and pending navigation data, canonical-boat commitment, broad southeast lead, and failure cleanup. The matching focused capture renders seven desktop/mobile states without entering accepted baselines.
