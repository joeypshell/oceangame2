...
The long-range product roadmap is `docs/planning/OCEANGAME_PHASE_2_ROADMAP.md`; the latest completed implementation contract and decision are `docs/current/OCEANGAME_EXPANSION_06_PLAN.md` and `docs/current/OCEANGAME_EXPANSION_06_CLOSEOUT.md`. Expansion 06 closed with GO after integrated journey coverage, focused visual review, and exact-SHA Web verification. Expansion 07 biological resources and weapon progression remains directional until its bounded plan is selected. Earlier controlled gameplay and visual passes remain implementation evidence, not the whole product direction.
...
- `scripts/main/main.gd`
  ...
  - Runs the minimal expedition loop: salvage and cargo banking, session upgrades/projects, prompted world-slice transition, oxygen/day pressure, current and moving-hazard avoidance, one optional territorial-hostile evade/fight encounter, combat health/defeat, completion/failure state, and route/objective feedback.
  - Delegates visual capture flags to `scripts/main/capture_controller.gd` and focused capture helpers, including camera tests, route outcome, timed/pry/cutter salvage, controlled-pass states, progression/connectors, anomaly survey, expedition day, Expansion 03 material/project, Expansion 04 current-pocket, Expansion 05 practical-research, and Expansion 06 combat review states.
  - Delegates smoke checks to `scripts/main/smoke/`, including safe/deep route comparison, timed/pry/cutter salvage, Expansion 03-06 journeys, focused combat health/hostile state, hazard and oxygen pressure, current gates, cargo/scoring, route/result/facing checks, and production-slice routes.
