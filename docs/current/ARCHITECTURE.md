...
The long-range product roadmap is `docs/planning/OCEANGAME_PHASE_2_ROADMAP.md`. Expansion 13 remains at owner HOLD after exact runtime `89371d6`. #1000-#1008 establish the active-tool correction, compact controls, named material presentation, sealed-wreck navigation reward, deterministic correction evidence, and focused desktop/mobile captures; final visual/Web review remains in #1009. #969 remains the owner replay gate and no next expansion is selected.
...
- `scripts/main/main.gd`
  ...
  - Delegates visual capture flags to `scripts/main/capture_controller.gd` and focused capture helpers, including camera tests, route outcome, timed/pry/cutter salvage, controlled-pass states, progression/connectors, anomaly survey, expedition day, Expansion 03 material/project, Expansion 04 current-pocket, Expansion 05 practical research, Expansion 06 combat, Expansion 07 biological progression, Expansion 08 daily-condition, Expansion 09 full-level, and Expansion 13 scanner/cutter correction states.
  - Delegates smoke checks to `scripts/main/smoke/`, including safe/deep route comparison, timed/pry/cutter salvage, Expansion 03-09 journeys, focused combat/biological/current/profile/condition state, scanner-cone targeting and presentation, Expansion 13 correction journey, hazard and oxygen pressure, cargo/scoring, route/result/facing checks, full-level continuous travel, and production-slice fixture routes.
