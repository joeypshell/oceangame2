...
- `scripts/main/main.gd`
  ...
  - Keeps durable capabilities, committed discoveries, banked typed materials, and exact-once project transactions in versioned `scripts/main/expansion_profile_state.gd`; schema v3 migrates valid v1 scanner/discovery and v2 cutter/material profiles. `scripts/main/material_project_runtime.gd` derives the source-ordered fins-to-cutter-to-stabilizer-to-weapon catalog, one-project-per-debrief readiness, and compact text. Session wallet, held cargo, candidate depletion, oxygen, daylight, and in-progress interactions are not profile-persistent.
