...
- `scripts/main/main.gd`
  ...
  - Delegates smoke checks to `scripts/main/smoke/`, including safe/deep route comparison, timed/pry/cutter salvage, Expansion 03-05 journeys, combat health/hostile state, hazard and oxygen pressure, current gates, cargo/scoring, route/result/facing checks, and production-slice routes.
