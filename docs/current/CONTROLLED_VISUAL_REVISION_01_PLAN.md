...
Accepted baseline directories under `visual_baselines/` remain unchanged by #70. Use the refreshed `production_slice_*_visual_baseline_review.png` sheets to review the expected prop-only visual differences before accepting any replacement baseline.
