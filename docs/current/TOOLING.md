...
The salvage-loop smoke also confirms the completion-only expedition result panel appears after a full collect-return run and reports the banked score, best score, and salvage totals.
