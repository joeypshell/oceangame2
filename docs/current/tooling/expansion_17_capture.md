...
progress, the completed western transponder's scanned/inactive state,
one-fragment return feedback, and the automatic two-fragment night result. It
uses isolated in-memory profile state
