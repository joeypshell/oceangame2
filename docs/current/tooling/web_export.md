...
For focused Living Expedition 04 review, use
...
current owner path for comparing Mica's threat read, Kite's non-damaging
Guardian Pulse opening, ordinary retreat, and Shock-Prod defeat/harvest.
