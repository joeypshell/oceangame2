...
def build_map_data(source_map: dict) -> dict:
    ...
    return {
        ...
        "entities": [
            ...
            {"id": "salvage_lower_loop", "type": "salvage", "x": 30, "y": 67, "kind": "relic"},
        ...
        "camera_tests": [
            {
                ...
                "center_y": 42,
                "zoom": 0.27,
                "intent": "Whole production-slice topology review.",
            },
            {
                ...
                "center_y": 14,
                "zoom": 0.58,
                "intent": "Boat entry, surface opening, and early descent review.",
            },
            {
