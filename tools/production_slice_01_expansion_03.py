...
def expansion_03_entities() -> list[dict]:
    return [
        _material_candidate(
            ...
            "titanium_scrap",
            "titanium_scrap_pool",
            "Entry-shaft titanium candidate in a small side pocket off the first descent.",
        ),
        _material_candidate(
            "material_titanium_crossing",
            55,
            ...
            "titanium_scrap",
            "titanium_scrap_pool",
            "Central-crossing titanium candidate in the right-side branch pocket.",
        ),
        _material_candidate(
            "material_titanium_return",
            23,
        ...
        _material_candidate(
            ...
            "Special component candidate in a side pocket off the moving-hazard deep approach.",
        ),
        _material_candidate(
            "material_coil_deep_cache",
            60,
            ...
            "conductive_coil",
            "conductive_coil_pool",
            "Special component candidate in a deliberate deep-cache side detour.",
        ),
        {
