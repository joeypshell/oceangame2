...
class ProductionLevelExpansion18Tests(unittest.TestCase):
    ...
    def test_navigation_core_is_one_cross_map_held_reward(self) -> None:
        ...
        self.assertEqual("chain_seal", core["tool_affordance_id"])
        self.assertEqual("chain-sealed navigation core", core["interaction_label"])
        self.assertIn("cut chains", core["mission_guidance"])
