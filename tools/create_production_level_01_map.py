...
import production_level_01_living_expedition_07 as living_expedition_07
...
def build_map_data(source_map: dict) -> dict:
    ...
    return living_expedition_07.author(living_expedition_06.author(living_expedition_05.author(living_expedition_04.author(living_expedition_03.author(living_expedition_02.author(living_expedition_01.author(expansion_18.author(expansion_17.author(expansion_16.author(author_expedition_leads({
