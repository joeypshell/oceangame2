#!/usr/bin/env python3
"""Validate the generated Living Expedition 04 visual-evidence set."""
...
CAPTURE_DIR = ROOT / "visual_captures" / "living_expedition_04"
...
def main() -> int:
    ...
    if manifest.get("review_checkpoint") != EXPECTED_CHECKPOINT:
        return fail("capture did not use the isolated LE04 checkpoint")
    ...
    tracked = subprocess.run(
        ["git", "ls-files", "--", "visual_captures/living_expedition_04/*.import"],
        cwd=ROOT,
        check=False,
        capture_output=True,
        text=True,
    ...
    print(
        "PASS: Living Expedition 04 captures "
