...
func refresh(material_report: Dictionary, sortie_report: Dictionary, capacity: int) -> void:
...
func _render_slots() -> void:
	...
	if _compact and _displayed_items.size() > COMPACT_SLOT_COUNT:
		var hidden_types := _displayed_items.size() - 2
		var compact_items: Array[Dictionary] = [_displayed_items[0], _displayed_items[1], {
			"id": "overflow",
