...
The Simple Diver and Phase 2 expansion roadmaps describe the completed runtime foundation. Living Expeditions 01-03 are implemented and owner-approved: Kite and Mica prove distinct mounted and sensing roles, one active next-sortie selection, an inhabited canonical boat, and one source-authored ecological observation that becomes Mica's useful next-day Drift Lens adaptation. Living Expedition 04 is technically complete and closed on HOLD: Guardian Pulse remains, Mica's eel prediction is retired, and corrected runtime `bbcc255` uses a whole-simulation BOND tactical pause. Living Expedition 05 is complete with owner GO at corrected runtime `7792a08` as a bounded Silt Hound excavation proof, not a broad roster, economy, or map expansion. Living Expedition 06 closes with owner GO through #1375 after deterministic journey, focused visual, and exact public Web evidence at `16300a9`. The active LE07 batch develops Marl through Guarded the Nest, deliberate night Root Claws, and a physical Ground Pin. Catalog/schema validation, source placement, refuge excavation, boat memory commitment, and deliberate night growth exist. Ground Pin is next (#1393); changed-fin presentation follows. The linked plan lists the ordered issues #1389-#1397. Habitat legacy/release stays directional, and #52/#53 remain deferred polish.

Core sources and operating docs:

- [Project Context](docs/current/PROJECT_CONTEXT.md)
...
- [Living Expedition 03 Plan](docs/current/LIVING_EXPEDITION_03_PLAN.md)
...
- [Living Expedition 04 Plan](docs/current/LIVING_EXPEDITION_04_PLAN.md)
...
- [OceanGame Expansion 01 Plan](docs/current/OCEANGAME_EXPANSION_01_PLAN.md)
- [Expansion 01 Survey Source Contract](docs/current/OCEANGAME_EXPANSION_01_SURVEY_SOURCE_CONTRACT.md)
...
- [Expansion 02 Visual Baseline Decision](docs/current/OCEANGAME_EXPANSION_02_VISUAL_BASELINE_DECISION.md)
- [Expansion 02 Web Preview Verification](docs/current/OCEANGAME_EXPANSION_02_WEB_PREVIEW_VERIFICATION.md)
- [Expansion 02 Closeout](docs/current/OCEANGAME_EXPANSION_02_CLOSEOUT.md)
...
- [Expansion 04 State Contract](docs/current/OCEANGAME_EXPANSION_04_STATE_CONTRACT.md)
- [Expansion 04 Source Contract](docs/current/OCEANGAME_EXPANSION_04_SOURCE_CONTRACT.md)
- [Expansion 04 Visual Baseline Decision](docs/current/OCEANGAME_EXPANSION_04_VISUAL_BASELINE_DECISION.md)
...
- [Expansion 06 State Contract](docs/current/OCEANGAME_EXPANSION_06_STATE_CONTRACT.md)
- [Expansion 06 Source Contract](docs/current/OCEANGAME_EXPANSION_06_SOURCE_CONTRACT.md)
...
- [Expansion 16 Source/State Contract](docs/current/OCEANGAME_EXPANSION_16_SOURCE_STATE_CONTRACT.md)
- [Expansion 16 Visual Baseline Decision](docs/current/OCEANGAME_EXPANSION_16_VISUAL_BASELINE_DECISION.md)
